...
/**
 * Week 6 - M2 : Payroll Salary Management
 * basicSalary and bonus are private - no public setter exists for either,
 * so the only way to change them is through the controlled methods below.
 */
public class PayrollAccount {
    ...
    public void deductTax(double percent) {
        if (percent < 0 || percent > 100) {
            System.out.println("Tax percentage must be between 0 and 100 - rejected");
            return;
        }
